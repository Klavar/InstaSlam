...
import uk.tonymerritt.instaslam.model.InstaImage;
   ...
   final int  PERMISSION_READ_EXTERNAl = 111;
    ...
    class DecodeBitmap extends AsyncTask<Void, Void, Bitmap> {
        ...
        protected void onPostExecute(Bitmap bitmap) {
            ...
            final ImageView img = mImageViewReference.get();
    ...
    public Bitmap decodeURI(String filePath) {
        ...
        if(options.outHeight * options.outWidth * 2 >= 16384) {
            // Load, scaling to smallest to the power of 2 that will get it <= desired dimensions
